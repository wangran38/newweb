<template>
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="iccid" width="110px" align="center">
          <template slot-scope="{row}">
            <span>{{ row.iccid }}</span>
          </template>
        </el-table-column>

       <el-table-column label="sim卡标识"  align="center">
          <template slot-scope="{row}">
            <span>{{ row.simid }}</span>
          </template>
        </el-table-column>
        <el-table-column label="msisdn号码"  align="center">
          <template slot-scope="{row}">
            <span>{{ row.msisdn }}</span>
          </template>
        </el-table-column>
        <el-table-column label="国际识别码" width="160px" align="center">
          <template slot-scope="{row}">
            <span>{{ row.imsi }}</span>
          </template>
        </el-table-column>
        <el-table-column label="套餐名称" width="160px" align="center">
          <template slot-scope="{row}">
            <span>{{ row.name }}</span>
          </template>
        </el-table-column>
        <!-- <el-table-column label="是否激活" width="160px" align="center">
          <template slot-scope="{row}">
            <span>{{ row.isopen }}</span>
          </template>
        </el-table-column> -->
        <el-table-column prop="status" :formatter="simStatus" label="状态" align="center">
        </el-table-column>
      ...
      <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
        <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px" style="width: 80%; margin-left:50px;">
          ...
          <el-form-item label="设备iccid编号" prop="">
            <el-input v-model.number="temp.iccid" />
          </el-form-item>

          <el-form-item label="sim编号" prop="">
            <el-input v-model.number="temp.simid" />
          </el-form-item>
          <el-form-item label="msisdn号" prop="">
            <el-input v-model="temp.msisdn" />
          </el-form-item>
          <el-form-item label="imsi国际识别码" prop="">
          ...
          <el-form-item label="套餐名称" prop="name">
           ...
           <el-form-item label="是否激活" prop="isopen">
            <el-switch
  v-model="temp.isopen" :active-value='1' :inactive-value='0'>
</el-switch>
          </el-form-item>
  ...
  <script>
  import { getlist, getoptions, add,edit,del } from '@/api/equipment/simcard/index'
...
//         }
      ...
      simStatus(row,column,cellValue){
        switch(cellValue) {
          case 0: 
        return '未操作'
        case 1: 
