<template>
    <div class="app-container">
      ...
      >
       ...
       <el-table-column label="信息名称" width="110px" align="center">
          <template slot-scope="{row}">
            <span>{{ row.title }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="是否显示" min-width="110px" align="center">
          <template slot-scope="{row}">
  <span>{{ row.isshow }}</span>
          </template>
        </el-table-column>
        <el-table-column label="当前状态" min-width="110px" align="center">
          <template slot-scope="{row}">
  <span>{{ row.status }}</span>
          </template>
        </el-table-column>
        <el-table-column label="排序" min-width="" align="center">
          <template slot-scope="{row}">
  <span>{{ row.weigh }}</span>
          </template>
        </el-table-column>
